...
import static com.ziwan.ziwanpicturebackend.constant.UserConstant.USER_LOGIN_STATE;

/**
 * 自定义权限加载接口实现类
 */
@Component    // 保证此类被 SpringBoot 扫描，完成 Sa-Token 的自定义权限验证扩展
public class StpInterfaceImpl implements StpInterface, Serializable {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (loginUser == null) {
            throw new BusinessException(ErrorCode.NO_AUTO_ERROR, "用户未登录");
        }
